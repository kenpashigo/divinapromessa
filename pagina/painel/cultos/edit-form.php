<div id="posts-titulo">
  <p>Adicionar novo culto gravado</p>
</div>
...
<div id="upload-total">
  ...
  <div id="preview">
    <div id="img-preview-holder">
      ...
      <div id="preview-container">
        ...
        <img src="../uploads/cultos/<?= $imagem ?>" alt="preview da imagem" id="img-sctn" />            
      </div>        
    </div>
  </div>   
  </div>
  ...
  <input type="text" name="pregador" class="form-input" placeholder="Pregador" value="<?= $pregador ?>" />
  ...
  <input type="text" name="resumo" class="form-input" placeholder="Título" value="<?= $resumo ?>" />
  ...
  <div class="upper-holder">
    ...
    <div id="button-uploader">
      ...
      <input type="file" name="baixa" class="form-input" id="low-quality-file" onchange="up_audio(0);" data-baix="<?= $low ?>" />
    </div>
    <div id="progress">
  ...
  <div class="upper-holder">
    ...
    <div id="button-uploader">
      ...
      <input type="file" name="baixa" class="form-input" id="med-quality-file" onchange="up_audio(1);" data-medi="<?= $med ?>" />
    </div>
    <div id="progress">
      <div id="progress-base">
        <div class="progress-atual"></div>
  ...
  <div class="upper-holder">
    ...
    <div id="button-uploader">
      ...
      <input type="file" name="baixa" class="form-input" id="hig-quality-file" onchange="up_audio(2);" data-alta="<?= $hig ?>" />
    </div>
    <div id="progress">
      <div id="progress-base">
        <div class="progress-atual"></div>
  ...
  <span id="enviar" onclick="culto_editar(<?= $id ?>);">Enviar</span>
